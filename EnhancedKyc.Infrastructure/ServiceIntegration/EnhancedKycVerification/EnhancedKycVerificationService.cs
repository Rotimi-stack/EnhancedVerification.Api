...
using EnhancedKycVerification.Application.Utilities;
using EnhancedKycVerification.Domain.Enum.EnhancedKycVerification;
...
namespace EnhancedKyc.Infrastructure.ServiceIntegration.EnhancedKycVerification
{
    public class EnhancedKycVerificationService : EnhancedKycVerificationInterface
    {
        ...
        private readonly KycContext _db;

        private static Logger log = LogManager.GetCurrentClassLogger();

        public EnhancedKycVerificationService(IHttpClientFactory httpClientFactory, IConfiguration config, ILogWritter logger, KycContext db)
        {
                ...
                case EnhancedKYCVerificationHttpMethodType.Post:
                    ...
                    try
                    {
                        ...
                        if (resp.IsSuccessStatusCode)
                        {
                            ...
                            requestForDb = new tblRequestandResponseLogs() { RequestType = "EnhancedKycVerification", RequestPayload = JsonConvert.SerializeObject(payload), Response = JsonConvert.SerializeObject(content), RequestTimestamp = DateTime.Now, ResponseTimestamp = DateTime.Now, RequestUrl = baseaddress };
